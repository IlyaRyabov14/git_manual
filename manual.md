...
*git archive* - Команда git archive используется для упаковки в архив указанных коммитов или всего репозитория.
## Как же поделиться своей работой?
1. *Создать аккаунт на Github.com*
2. *Создать локальный репозиторий*
3. "Подружить" ваш локалььный и удалённый репозиторий. Github подскажет как это сделать.
4. *Отправить (push) ваш локальный репозиторий (на Github), при этом, вам возможно придется авторизоваться на удалённом репозитории.
